...
// blurryllama: sync typing speed and custom state to the other half for Luna
#define SPLIT_WPM_ENABLE
#define SPLIT_TRANSACTION_IDS_USER USER_SYNC_STATE

// blurryllama: the displays load five font sizes
#define QUANTUM_PAINTER_NUM_FONTS 6

// blurryllama: the neon Luna images use a 256-colour palette. Without this, Quantum Painter still
// draws them but loads their palette into a 16-entry table, overwriting the memory after it.
